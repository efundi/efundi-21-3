...
public class ShowPageProducer implements ViewComponentProducer, DefaultView, NavigationCaseReporter, ViewParamsReporter {
	...
	private void createExportEpubDialog(UIContainer tofill, SimplePage page) {
		UIOutput.make(tofill, "export-epub-dialog").decorate(
				new UIFreeAttributeDecorator("title", messageLocator.getMessage("simplepage.export-epub-title")));
	...
	private void createImportPdfDialog(UIContainer tofill, SimplePage page) {
		UIOutput.make(tofill, "import-pdf-dialog").decorate(
				new UIFreeAttributeDecorator("title", messageLocator.getMessage("simplepage.import-pdf-title")));
	...
	private void createImportDocxDialog(UIContainer tofill, SimplePage page) {
		UIOutput.make(tofill, "import-docx-dialog").decorate(
				new UIFreeAttributeDecorator("title", messageLocator.getMessage("simplepage.import_docx-title")));

		UIForm form = UIForm.make(tofill, "import-docx-form");
		// UICommand.make(form, "import-docx-ok",
		// messageLocator.getMessage("simplepage.import-docx-ok"), null);

		UICommand.make(form, "import-docx-submit", messageLocator.getMessage("simplepage.save_message"),
	...
	private void createExportDocxDialog(UIContainer tofill, SimplePage page) {
		UIOutput.make(tofill, "export-docx-dialog").decorate(
				new UIFreeAttributeDecorator("title", messageLocator.getMessage("simplepage.export-docx-title")));
