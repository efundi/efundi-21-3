...
For rationales, please check the [docs](https://github.com/ing-bank/lion/blob/master/packages/overlays/docs) folder, where we go more in-depth. Or check out the Storybook demos which also contains more info.
